...
|---------|-------------|------------|
| **[Tech Trend Tracker](https://techtrendtracker.xyz)** | Distributed data pipeline processing 10,000+ job descriptions to visualize real-time tech skill demands using local Llama 3 inference. | Python, Go, React, RabbitMQ, Docker, Ollama, Gemma4, PostGreSQL |
